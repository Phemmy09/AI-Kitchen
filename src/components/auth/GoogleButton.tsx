...
export function GoogleButton({ label }: { label: string }) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-lg border border-panel-border bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10 disabled:opacity-50"
    >
